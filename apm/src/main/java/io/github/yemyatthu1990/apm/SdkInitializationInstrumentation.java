...
class SdkInitializationInstrumentation implements InteractionInstrumentor{
    ...
    static void init(long sdkInitializationTime) {
        SdkInitializationInstrumentation.sdkInitializationTime =sdkInitializationTime;
    }
    static SdkInitializationInstrumentation getInstance(Span appStartSpan) {
